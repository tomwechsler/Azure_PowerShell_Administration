...
$VaultName = 'twrsv2022' #fetch automatically
$Subscription = 'Nutzungsbasierte Bezahlung' #fetch automatically
$ResourceGroup = 'az-104-rg' #fetch automatically
$SubscriptionId = '34c9efb6-c3a2-4d9d-924a-6ddaa9d55272' #fetch automatically
