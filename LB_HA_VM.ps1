...
$vmConfig = New-AzureRmVMConfig -VMName 'myVM1' -VMSize Standard_D2s_v3 -AvailabilitySetId $as.Id | `
...
$vm1 = New-AzureRmVM -ResourceGroupName $rgName -Location $location -VM $vmConfig -AsJob
...
# Create a virtual machine configuration
$vmConfig2 = New-AzureRmVMConfig -VMName 'myVM2' -VMSize Standard_D2s_v3 -AvailabilitySetId $as.Id | `
...
# Create a virtual machine
$vm2 = New-AzureRmVM -ResourceGroupName $rgName -Location $location -VM $vmConfig2 -AsJob

# ############## VM3 ###############

# Create a virtual machine configuration
$vmConfig3 = New-AzureRmVMConfig -VMName 'myVM3' -VMSize Standard_Ds1_v2 -AvailabilitySetId $as.Id | `
...
# Create a virtual machine
$vm3 = New-AzureRmVM -ResourceGroupName $rgName -Location $location -VM $vmConfig3 -AsJob
...
Remove-AzureRmResourceGroup -Name tw-azure-01 -Force